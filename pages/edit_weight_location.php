            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Edit Weight of Location </a>
                    </div>
            ...
            <div class="content">
				...
				mysqli_set_charset($dbcon, 'utf8'); 
				 ...
				 $query = "SELECT province.PROVINCE_NAME as PROVINCE_NAME,
				 				  ...
				 				  weightlocation.TYPE as TYPE, 
				 				  weightlocation.WEIGHTOFTYPE as WEIGHTOFTYPE, 
				 				  weightlocation.ID as ID FROM weightlocation
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card card-profile">
                                ...
                                <div class="content">
                                    <h6 class="category text-gray">Edit Weight Location ( <?php echo $row['TYPE'] ; ?> )</h6>
                                    
	                                <div class="card-content">
	                                	<form id="form1" action="../service/update_weight_location.php" method="post" class="form" enctype="multipart/form-data"  novalidate>
  ...
  $(document).ready(function() {
      ...
      $('#form1').on("submit",function(e) {
        ...
        if ($('#form1').smkValidate()) {
            ...
            $.ajax({
              url: '../service/update_weight_location.php',
              type: 'POST',
