        ...
        <div class="main-panel">
            ...
            <div class="content">
                    <div class="container-fluid">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    <div class="card-header" data-background-color="orange">
                                        <h4 class="title">แสดง Weight Factor</h4>
                                        <p class="category"></p>
                                    </div>
                                    <div class="card-content table-responsive">
                                        <table class="table table-hover" id="table" data-toggle="table" data-url="../service/weight_location.php"
                                            ...
                                            <thead class="text-warning">
                                                ...
                                                <th data-field="WEIGHTOFTYPE" data-align="center">น้ำหนัก factor</th>
                        ...
                        <button class="btn btn-warning" onclick='location.replace("add_locationtype.php")' style="font-size: 20px;width: 350px;"> เพิ่มประเภทสถานที่</a></button>
...
<script>
  function operateFormatter(value, row, index) {
        return [
            ...
            '</a>',
            '<a class="del btn btn-primary" href="javascript:void(0)" title="ลบ">',
  ...
  window.operateEvents = {
     'click .look': function (e, value, row) {
      window.location.replace('edit_weight_location.php?id='+row.ID);
     },
     'click .del': function (e, value, row, index) {
        let id = row.ID;
        var con = confirm('คุณต้องการที่จะลบสถานที่นี้ใช่ไหม?');
        if(con == true){
            window.location.replace('../service/del_weight_location.php?id='+row.ID).done(function( data) {
