                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    <div class="card-header" data-background-color="orange">
                                        <h4 class="title">แสดง Weight Road</h4>
                                        <p class="category"></p>
                                    </div>
                                    <div class="card-content table-responsive">
                                        <table class="table table-hover" id="table" data-toggle="table" data-url="../service/weight_road.php"
                                            ...
                                            <thead class="text-warning">
                                                ...
                                                <th data-field="TYPE" data-align="center">ชนิด</th>
