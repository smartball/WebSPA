<?php 
	...
	mysqli_set_charset($dbcon, 'utf8'); 
	 ...
	 $query = "SELECT province.PROVINCE_NAME as PROVINCE_NAME,amphur.AMPHUR_NAME as AMPHUR_NAME,weightlocation.TYPE as TYPE, weightloaction.WEIGHTOFTYPE as WEIGHTOFTYPE, weightloaction.ID as ID FROM weightloaction
